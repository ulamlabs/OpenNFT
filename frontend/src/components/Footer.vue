  ...
  >
    <div class="flex text-center">
      <router-link
        ...
        :to="entry.to"
        :exact="entry.exact"
        class="block text-base leading-6 font-normal text-gray-500 hover:text-gray-400 mx-5"
      >
        {{ entry.label }}
      </router-link>
    </div>
    <div class="flex space-x-7">
      <a
        href="https://www.facebook.com/ulamlabs"
        target="blank"
      ...
      >
        ...
        >
          <path
            d="M19.6 1.09908L1.89997 7.89908C0.699973 8.39908 0.699974 9.09908 1.69997 9.39908L6.19997 10.7991L7.79997 15.9991C7.99997 16.5991 7.89997 16.7991 8.49997 16.7991C8.99997 16.7991 9.19997 16.5991 9.39997 16.2991L11.6 14.1991L16.2 17.5991C17 18.0991 17.7 17.7991 17.9 16.7991L20.9 2.59908C21.2 1.29908 20.5 0.699077 19.6 1.09908ZM10.1 11.9991L8.59997 15.3991L6.99997 10.4991L18.5 3.69908L10.1 11.9991Z"
            fill="currentColor"
          />
        </svg>
      </a>
      <a
        href="https://twitter.com/ulamlabs"
        target="blank"
        class="text-gray-400 hover:text-gray-500"
      >
        <svg
    ...
    <div class="text-base leading-6 font-normal text-gray-400">
      © 2021 Ulam Labs. All rights reserved.
    </div>
  </footer>
</template>
<script>
